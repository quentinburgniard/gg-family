...
class WorkflowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workflow" do
    assert_difference('Workflow.count') do
      post workflows_url, params: { workflow: { description: @workflow.description, name: @workflow.name } }
    end
  ...
  test "should update workflow" do
    patch workflow_url(@workflow), params: { workflow: { description: @workflow.description, name: @workflow.name } }
